...
export default function Carousel(props) {
  ...
  const images = [
    ...
    },
    {
      id: 2,
      sourceIcon:
        "https://cf.shopee.vn/file/96f17971787f975c80dbdc0ff11d7435_xxhdpi",
    },
    {
      id: 3,
      sourceIcon:
        "https://cf.shopee.vn/file/https://cf.shopee.vn/file/c851f4745146f1c66284c6a186fd1dc3_xxhdpi",
    },
  ];
  ...
  const listData = props.listData == null ? images : props.listData;
  return (
    <SafeAreaView style={{ width, height }}>
      ...
      >
        {listData.map((image, key) => (
          <Text key={key} style={key == active ? styles.activeDot : styles.dot}>
            ●
          </Text>
        ))}
      </View>
