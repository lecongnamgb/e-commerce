...
export default function FliterBar(props) {
    ...
    <View style={[styles.mt_15, styles.flex_row, styles.hr_bottom]}>
      <TouchableOpacity
        ...
        style={[
          { width: "26%" },
          styles.pb_15,
          currentFocus[0] ? styles.filterBar_active : null,
        ]}
        onPress={() => {
          setCurrentFocus([true, false, false, false]);
          setAsending("");
        }}
        onPressIn={props.handlePress1}
      >
        <View
          style={[
        ...
        >
          <Text
            style={[
              { textAlign: "center" },
              currentFocus[0] ? styles.filterBar_text_active : null,
            ]}
          >
            Liên quan
          </Text>
      ...
      <TouchableOpacity
        ...
        style={[
          { width: "25%" },
          styles.pb_15,
          currentFocus[1] ? styles.filterBar_active : null,
        ]}
        onPress={() => {
          setCurrentFocus([false, true, false, false]);
          setAsending("");
        }}
        onPressIn={props.handlePress2}
      >
        <View
          style={[
            { borderRightWidth: 1, borderRightColor: "#ccc" },
        ...
        >
          <Text
            style={[
              { textAlign: "center" },
              currentFocus[1] ? styles.filterBar_text_active : null,
            ]}
          >
            Mới nhất
          </Text>
      ...
      <TouchableOpacity
        ...
        style={[
          { width: "25%" },
          styles.pb_15,
          currentFocus[2] ? styles.filterBar_active : null,
        ]}
        onPress={() => {
          setCurrentFocus([false, false, true, false]);
          setAsending("");
        }}
        onPressIn={props.handlePress3}
      >
        <View
          style={[
            { borderRightWidth: 1, borderRightColor: "#ccc" },
        ...
        >
          <Text
            style={[
              { textAlign: "center" },
              currentFocus[2] ? styles.filterBar_text_active : null,
            ]}
          >
            Bán chạy
          </Text>
      ...
      <TouchableOpacity
        ...
        style={[
          { width: "25%" },
          styles.pb_15,
          currentFocus[3] ? styles.filterBar_active : null,
        ]}
        onPress={() => {
          if (ascending == "") {
            setAsending(true);
      ...
      >
        ...
        >
          <Text
            style={[
              { textAlign: "center" },
              currentFocus[3] == true ? { color: "red" } : null,
            ]}
          >
            Giá{" "}
            <View>
